...
// -------
//
function ciniki_customers_web_dealerLocationTagCloud($ciniki, $settings, $tnid, $args) {
...
//          . "AND ciniki_customers.dealer_status = 10 " // Must be active dealer
        ...
        if( isset($rc['tags']) ) {
            ...
            if( count($rc['tags']) == 1 ) {
                ...
                return ciniki_customers_web_dealerLocationTagCloud($ciniki, $settings, $tnid, $args);
            } else {
