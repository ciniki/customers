...
// <rsp stat='ok' />
//
function ciniki_customers_seasonUpdate(&$ciniki) {
    //  
    ...
    $rc = ciniki_customers_checkAccess($ciniki, $args['business_id'], 'ciniki.customers.seasonUpdate', 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }
	$modules = $rc['modules'];
	...
	$rc = ciniki_core_objectUpdate($ciniki, $args['business_id'], 'ciniki.customers.season', 
		$args['season_id'], $args, 0x04);
	if( $rc['stat'] != 'ok' ) {
