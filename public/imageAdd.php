...
function ciniki_customers_imageAdd(&$ciniki) {
    ...
    $rc = ciniki_customers_checkAccess($ciniki, $args['business_id'], 'ciniki.customers.imageAdd', 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
	...
	if( $args['customer_id'] <= 0 ) {
		return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'932', 'msg'=>'No customer specified'));
	}
	...
	return ciniki_core_objectAdd($ciniki, $args['business_id'], 'ciniki.customers.image', $args, 0x07);
}
?>
