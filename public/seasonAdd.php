...
function ciniki_customers_seasonAdd(&$ciniki) {
    ...
    $rc = ciniki_customers_checkAccess($ciniki, $args['business_id'], 'ciniki.customers.seasonAdd', 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }
	...
	$rc = ciniki_core_objectAdd($ciniki, $args['business_id'], 'ciniki.customers.season', $args, 0x04);
	if( $rc['stat'] != 'ok' ) {
