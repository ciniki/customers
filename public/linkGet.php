...
function ciniki_customers_linkGet($ciniki) {
    ...
    $rc = ciniki_customers_checkAccess($ciniki, $args['tnid'], 'ciniki.customers.linkGet', 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    if( !isset($rc['link']) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.customers.102', 'msg'=>'Invalid link'));
    }
