...
function ciniki_customers_imageDelete(&$ciniki) {
    ...
    $rc = ciniki_customers_checkAccess($ciniki, $args['tnid'], 'ciniki.customers.imageDelete', 0); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    return ciniki_core_objectDelete($ciniki, $args['tnid'], 'ciniki.customers.image', $args['customer_image_id'], $uuid, 0x07);
}
?>
