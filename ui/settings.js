...
/*            
            ...
            'other_labels':{'label':'Extra Field Labels', 'visible':'yes', 'fields':{
                'other-1-label':{'label':'#1', 'type':'text'},
                'other-2-label':{'label':'#2', 'type':'text'},
                'other-3-label':{'label':'#3', 'type':'text'},
                'other-4-label':{'label':'#4', 'type':'text'},
                'other-5-label':{'label':'#5', 'type':'text'},
                'other-6-label':{'label':'#6', 'type':'text'},
                'other-7-label':{'label':'#7', 'type':'text'},
                'other-8-label':{'label':'#8', 'type':'text'},
                'other-9-label':{'label':'#9', 'type':'text'},
                'other-10-label':{'label':'#10', 'type':'text'},
                'other-11-label':{'label':'#11', 'type':'text'},
                'other-12-label':{'label':'#12', 'type':'text'},
            }},
