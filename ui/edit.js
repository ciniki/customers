...
function ciniki_customers_edit() {
    ...
    this.edit.forms.person = {
        ...
        'name':{'label':'Name', 'aside':'yes', 'fields':{
            ...
            'flags5':{'label':'Cheque Payments', 'type':'flagtoggle', 'bit':0x10, 'field':'flags', 'default':'off',
                'off':'No', 'on':'Allowed',
                'visible':function() { return M.modFlagSet('ciniki.sapos', 0x8000); },
                },
            'flags9':{'label':'CRC', 'type':'flagtoggle', 'bit':0x0100, 'field':'flags', 'default':'off',
                'off':'Not Checked', 'on':'Checked',
                'visible':function() { return M.modFlagSet('ciniki.customers', 0x100000); },
                },
            'crc_expiry_date':{'label':'CRC Expiry', 'type':'date',
                'visible':function() { return M.modFlagSet('ciniki.customers', 0x100000); },
                },
